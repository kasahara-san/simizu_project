...
def generate_launch_description():
    ...
    sample_tms_ts_construction_launch_file = os.path.join(tms_ts_launch_dir, 'launch', 'sample_tms_ts_construction.launch.py')
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(sample_tms_ts_construction_launch_file),
            launch_arguments={
